...
<div class="modal fade" id="AgregarResumen">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
    
          <!-- cabecera del diálogo -->
          <div class="modal-header">
            <h4 class="modal-title">Agregar resumen ejecutivo</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="basic-login-inner modal-basic-inner">
                                <p>Responda según corresponde</p>
                                <form action="?c=resumen&a=Guardar" method="POST">
